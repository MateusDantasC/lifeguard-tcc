...
import type { ElderProfile, Gender } from './authStore';
...
export type Caregiver = { id: string; usuarioId: string; nome: string; telefone: string; foto?: string | null; vinculadoDesde: string };
